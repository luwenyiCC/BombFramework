...
namespace HotFix_Project
{
    public class TestDelegate
    {
        ...
        public static void MyInitialize2()
        {
            MyDelegateDemo.TestMethodDelegate = Method;
            MyDelegateDemo.TestFunctionDelegate = Function;
            MyDelegateDemo.TestActionDelegate = Action;
        }
        public static void RunTest2()
        {
            MyDelegateDemo.TestMethodDelegate(123);
            var res = MyDelegateDemo.TestFunctionDelegate(456);
            UnityEngine.Debug.Log("!! TestDelegate.RunTest2 res = " + res);
            MyDelegateDemo.TestActionDelegate("rrr");
        }
        public static void MyRunTest2()
        {
            MyDelegateDemo.TestMethodDelegate(123);
            var res = MyDelegateDemo.TestFunctionDelegate(456);
            UnityEngine.Debug.Log("!! TestDelegate.RunTest2 res = " + res);
