...
{
    unsafe class BombServer_Kernel_KeyObjectMap_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            MethodBase method;
            Type[] args;
            Type type = typeof(BombServer.Kernel.KeyObjectMap);
        ...
        static StackObject* Get_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BombServer.Kernel.KeyObjectMap instance_of_this_method = (BombServer.Kernel.KeyObjectMap)typeof(BombServer.Kernel.KeyObjectMap).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
