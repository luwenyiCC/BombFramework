...
{
    unsafe class TcpSession_Binding
    {
        ...
        static StackObject* Send_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            TcpSession instance_of_this_method = (TcpSession)typeof(TcpSession).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Send(@buffer);
